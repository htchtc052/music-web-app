...
import { IsSlugValid } from '../../common/isSlugValid.validator';
import { Match } from '../../common/match.decorator';
import { IsFieldAllreadyExists } from 'src/user/validators/isFieldAllreadyExists.validator';
...
export class RegisterDto {
  ...
  @Validate(IsSlugValid, {
    message: i18nValidationMessage('validation.SLUG_INVALID'),
  })
  @Validate(IsFieldAllreadyExists, {
    message: i18nValidationMessage('validation.SLUG_BUSY'),
  })
  slug: string;
